\begin{titlepage}
    \begin{center}
        ...
        {\LARGE \textbf{Trabajo Práctico 3: Pipeline RISC-V}}\\[0.3cm]
        \rule{\linewidth}{0.5mm}\\[1cm]

        \begin{flushleft}
        {\large 
            \textbf{Profesores:} Martín Pereyra, Santiago Rodríguez\\
            \textbf{Integrantes:}\\
            Pallardó Agustín - DNI: 43.147.213 - 
            \href{mailto:apallardo@mi.unc.edu.ar}{apallardo@mi.unc.edu.ar}\\
            Trachta Agustín - DNI: 43.271.890 - 
