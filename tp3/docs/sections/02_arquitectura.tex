...
Como el reloj interno del sistema trabaja a frecuencias mucho mayores ($85$ a $100$ MHz) que la velocidad de transmisión serie, fue necesario incorporar buffers intermedios mediante \texttt{fifo.v}.
